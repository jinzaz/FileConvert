...
namespace Microsoft.AspNetCore.ConcurrencyLimiter
{
    ...
    public class ConcurrencyLimiterMiddleware
    {
        ...
        private readonly List<string> _actionList;
        /// <summary>
        ...
        /// <param name="queueOptions">The options for the middleware, currently containing the 'OnRejected' callback.</param>
        public ConcurrencyLimiterMiddleware(RequestDelegate next, ILoggerFactory loggerFactory, IQueuePolicy queue, IOptions<ConcurrencyLimiterOptions> options, IOptions<QueuePolicyOptions> queueOptions)
        {
            ...
            _queuePolicy = queue;
            _actionList = queueOptions.Value.RequestQueueForActions;
        }
        ...
        {
            if (_actionList.Exists(x => x.Contains(context.Request.Path.Value)))
            {
